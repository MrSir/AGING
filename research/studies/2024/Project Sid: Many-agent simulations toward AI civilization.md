...
Source: [Project Sid: Many-agent simulations toward AI civilization](https://arxiv.org/abs/2411.00114)
...
## Key Points
A simulation of civilizations built entirely of AI agents, within the world of Minecraft. Findings:
- agents were about to automatically organize themselves into distinct specialized roles
- influencers in civilizations were able to affect sentiment and voting in favour of their agenda and ultimately influence the civilization's constitution (taxes)
- priests had a significantly smaller impact on religious transmission, than the indirect effects of communication between agents
